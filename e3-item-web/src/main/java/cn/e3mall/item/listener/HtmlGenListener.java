...
public class HtmlGenListener implements MessageListener {
	...
	public void onMessage(Message message) {
		try {
			...
			System.out.println("接受到消息》》》》》》》》》》》》》》》"  + item.getId() + ":" + item.getTitle());
			//取商品描述
			...
			//创建一个输出流，指定输出的目录及文件名。
			Writer out = new OutputStreamWriter(new FileOutputStream(HTML_GEN_PATH + id + ".html"), "utf-8");
			//生成静态页面。
